...
ctrl_b1 = 'ctrl_b1_hwe.recode.vcf'
...
ctrl_b2 = 'ctrl_b2_hwe.recode.vcf'
...
ctrl_b1_gq_avg.to_csv('ctrl_b1_gq_avg.csv')
ctrl_b2_gq_avg.to_csv('ctrl_b2_gq_avg.csv')

ctrl_b1_gq_avgpos = ctrl_b1_gq_avg[ctrl_b1_gq_avg < 30].reset_index().drop(axis = 1, labels = 'avg').to_csv('ctrl_b1_gq_avgPOS.tsv', sep = '\t', index = False)
ctrl_b2_gq_avgpos = ctrl_b2_gq_avg[ctrl_b2_gq_avg < 30].reset_index().drop(axis = 1, labels = 'avg').to_csv('ctrl_b2_gq_avgPOS.tsv', sep = '\t', index = False)

case_b1 = 'case_b1.recode.vcf'
...
case_b1_gq_avg.to_csv('case_b1_gq_avg.csv')
case_b2_gq_avg.to_csv('case_b2_gq_avg.csv')

case_b1_gq_avgpos = case_b1_gq_avg[case_b1_gq_avg < 30].reset_index().drop(axis = 1, labels = 'avg').to_csv('case_b1_gq_avgPOS.tsv', sep = '\t', index = False)
case_b2_gq_avgpos = case_b2_gq_avg[case_b2_gq_avg < 30].reset_index().drop(axis = 1, labels = 'avg').to_csv('case_b2_gq_avgPOS.tsv', sep = '\t', index = False)
