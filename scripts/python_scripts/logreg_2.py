...
wd = '/mnt/Adenina/drobles/ccastaneda/gwas-reseq/regions/'+region
os.chdir(wd)

fisher = pd.read_csv(wd+'/'+region+'_fisher.csv', low_memory=False).drop(axis = 1, labels = {'Unnamed: 10', 'ID_x', 'CHR'})
...
os.chmod('/mnt/Adenina/drobles/ccastaneda/gwas-reseq/bash_scripts/logreg_1.sh', 0o755)
with open('/mnt/Adenina/drobles/ccastaneda/gwas-reseq/bash_scripts/logreg_1.sh', 'rb') as file:
    script = file.read()
...
os.chmod('/mnt/Adenina/drobles/ccastaneda/gwas-reseq/bash_scripts/logreg_2.sh', 0o755)

with open('/mnt/Adenina/drobles/ccastaneda/gwas-reseq/bash_scripts/logreg_2.sh', 'rb') as file:
    script = file.read()
rc = subprocess.call(script, shell=True)
...
if emptyr2:
        ...
        with open('to_condition', 'w') as f:
                for var in top_cond2:
                        f.write("%s\n" % var)
        os.chmod('/mnt/Adenina/drobles/ccastaneda/gwas-reseq/bash_scripts/logreg_3.sh', 0o755)

        with open('/mnt/Adenina/drobles/ccastaneda/gwas-reseq/bash_scripts/logreg_3.sh', 'rb') as file:
                script = file.read()
        rc = subprocess.call(script, shell=True)
...
os.chmod('/mnt/Adenina/drobles/ccastaneda/gwas-reseq/bash_scripts/vep_annotate_candidates.sh', 0o755)

with open('/mnt/Adenina/drobles/ccastaneda/gwas-reseq/bash_scripts/vep_annotate_candidates.sh', 'rb') as file:
	script = file.read()
